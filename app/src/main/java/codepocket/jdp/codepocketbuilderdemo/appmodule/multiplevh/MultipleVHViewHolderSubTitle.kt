...
import codepocket.jdp.codepocketbuilderdemo.global.model.obj.multiplevh.SubTitle
import jdp.pocketlib.base.PocketViewHolder

class MultipleVHViewHolderSubTitle(
    ...
    override fun onBindViewHolder(view: View, position: Int) {
        view.findViewById<TextView>(R.id.tvTitle).text= (adapter.dataList[position] as SubTitle).title
    }
}
